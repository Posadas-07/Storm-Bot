...
`.trim()
    ...
    partidasVS10[newMsg.key.id] = data
    partidasVS10[newMsg.key.id].originalMsgKey = newMsg.key
    delete partidasVS10[key.id]
  })
}

handler.command = ['vs10']
